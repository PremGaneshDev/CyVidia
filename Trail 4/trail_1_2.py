# working but using single data set
...
# convert all the binary values to human readable format and save it to excel file 
...
# convert the cleaned description column back to text format

validation_df['Cleaned_Description'] = tokenizer.sequences_to_texts(validation_df['Cleaned_Description'].tolist()) # type: ignore

validation_df['Cleaned_Description'] = validation_df['Cleaned_Description'].apply(lambda x: x.split(' '))

validation_df['Cleaned_Description'] = validation_df['Cleaned_Description'].apply(lambda x: ' '.join([str(i) for i in x]))
